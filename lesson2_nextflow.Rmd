...
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop$ mkdir nextflow_example; cd nextflow_example
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ echo one > one.txt
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ echo two > two.txt
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ cat >> simple-pipeline.nf

<paste the pipeline code shown above here, then type Ctrl+D>

[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ nextflow run simple-pipeline.nf
...
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ head results/*
...
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$
...
```bash
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ rm -r ./*
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ echo one > one.txt
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ echo two > two.txt
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ nextflow run simple-pipeline.nf --in one.txt
...
```bash
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ sed 's/ rev / broken_rev /' simple-pipeline.nf > broken-pipeline.nf  # this effectively breaks the rev command, resulting in a pipeline that will fail

[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ nextflow run broken-pipeline.nf
...
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ sed --in-place 's/ broken_rev / rev /' broken-pipeline.nf  # this fixes the rev command in broken-pipeline.nf

[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ nextflow run broken-pipeline.nf -resume
...
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ rm broken-pipeline.nf
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ 
```
...
```bash
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ tree -a
...
```bash
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ find work -name .command.sh -exec bash -c "echo {}': '; cat {}" \; 
```

You could also use *nextflow log*, specifying the name of the run:

```bash
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ nextflow log soggy_shaw -f process,workdir
```
</div>
</details>
</div>
...
One of the easiest ways to perform an NGS analysis can to use a pre-existing pipeline. A good example of a high quality, flexible, and well maintained pre-built *nextflow* pipeline for RNA-Seq analysis is provided by [nf-core](https://nf-co.re/). 
...
Control_1,Control_1.fq.gz,,forward
Control_2,Control_2.fq.gz,,forward
Control_3,Control_3.fq.gz,,forward
MOV10_OE_1,MOV10_OE_1.fq.gz,,forward
MOV10_OE_2,MOV10_OE_2.fq.gz,,forward
MOV10_OE_3,MOV10_OE_3.fq.gz,,forward
```
...
```bash
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nextflow_example$ cd ..
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop$ mkdir nfcore_rnaseq_example; cd nfcore_rnaseq_example
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nfcore_rnaseq_example$ ln -s ../annotation
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nfcore_rnaseq_example$ ls ../fastq/*.fq.gz | xargs -I {} ln -s {}
[USERNAME]@bifx-core3:~/public_html/RNA-seq_workshop/nfcore_rnaseq_example$ cat >> samplesheet.csv
sample,fastq_1,fastq_2,strandedness
Control_1,Control_1.fq.gz,,forward
Control_2,Control_2.fq.gz,,forward
Control_3,Control_3.fq.gz,,forward
